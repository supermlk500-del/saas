...
public class ProductionPlanController {
    ...
    @GetMapping("/{planId}/machine-loads")
    public AjaxResult machineLoads(@PathVariable @Min(value = 1, message = "planId 必须大于 0") Long planId) {
        return AjaxResult.success(productionPlanService.getMachineLoads(planId));
    }
}
